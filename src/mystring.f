      SUBROUTINE BFRSTRING(STR,LUN,I1,IO)
...
C                           BORT TO BORT2
C
C USAGE:    CALL BFRSTRING(STR, LUN, I1, IO)
...
C$$$
     ...
     .                INODE(NFILES),IDATE(NFILES)
      ...
      CHARACTER*(*) STR
      CHARACTER*255 BORT_STR1,BORT_STR2
...
C  -----
      ...
      RETURN
900   WRITE(BORT_STR1,'("BUFRLIB: STRINGi - INPUT STRING (",A,") HAS")')
     . STR
